...
import emailnator from "./emailnator/index";
import tempTf from "./temp-tf/index";

import { createRegistry, validateTempMail, type TempMailDescriptor } from "../contract";

export const TEMP_MAIL = createRegistry<TempMailDescriptor>("temp-mail", [
  tempTf,
  emailnator,
], validateTempMail);
