...
import { DEFAULT_VALUES, fetchAddress, fetchMessages, PROVIDER_CHOICES, validate } from "./api";
...
export default {
  ...
  // yenə də işləyir. Qaytarılan siyahı shared/extract.ts-in oxuduğu formada olmalıdır.
  fetchMessages,
