...
// Ona görə aktivasiya məktubunun seçilməsi shared/extract.js-in relay ipuçlarına söykənir:
// qutudakı hər kod deyil, yalnız işlədilən relay saytına aid olan tapılır.
import { FieldType } from "../../../shared/options.js";
import { DEFAULT_VALUES, fetchAddress, fetchMessages, TYPE_CHOICES } from "./api.js";
...
export default {
  ...
  // saytın öz origin-i ilə əvəz olunur (bax: shared/net.js, rules/provider-origin.json).
  ...
  // ona görə `wait` api.js-də emulyasiya olunur — döngü fasiləsiz sorğu göndərmir.
  fetchMessages,
};
