...
// açıq tabındaki saytı mənimsəyir və qeydiyyatı evristika ilə aparır (bax: background/forms.ts).
...
//   1) bu qovluqda yeni qovluq yarat: <slug>/index.ts (deskriptor)
...
import activeTab from "./active-tab/index";

import { createRegistry, validateRelay, type RelayDescriptor } from "../contract";

export const RELAY = createRegistry<RelayDescriptor>("relay", [
  activeTab,
], validateRelay);
