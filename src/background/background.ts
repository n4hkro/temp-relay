...
// orchestrator-a ötürmək. İş məntiqi orchestrator.ts-də, mexanika qonşu modullarda,
...
// shared/state.ts-dədir; worker-in yaddaşında heç nə saxlanılmır.

import { isExpected } from "../shared/errors";
import { isForOffscreen } from "../shared/messages";
import { resumeWatching } from "./inbox";
import { handleCommand, onPermissionsGranted, onTabClosed } from "./orchestrator";
import { answerProxyAuth, migrateProxies, resumeProxy } from "./proxy";
import { handleToolCommand, isToolCommand } from "./tools";
import { resumeShield } from "./trackers";
