...
//
// Niyə ayrı fayl: silmə mexanikası worker-dədir (background/cleanup.js) və `chrome`-a
...
import { registrableDomain } from "./extract.js";
...
export const IDENTITY_FAMILIES = Object.freeze([
  Object.freeze({
    id: "microsoft",
...
export function identityFamily(host) {
...
const isWeb = (protocol) => protocol === "http:" || protocol === "https:";
...
export function tabCleanupPlan(url) {
  let parsed = null;
