...
import {fillFormInPage} from '/src/background/forms.js';
...
server.listen(0, "127.0.0.1", () => console.log(`QA fixtures: http://127.0.0.1:${server.address().port}/src/popup/popup.html, /form, /latency and /opener`));
